            ...
            <div className="p-8 flex flex-col items-center gap-6">
              ...
              <div className="w-full flex flex-col sm:flex-row gap-3 mt-2">
                <a
                  ...
                  className="flex-1 inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-linear-to-r from-teal-500 to-emerald-500 rounded-lg font-semibold text-white shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105 text-sm"
                >
