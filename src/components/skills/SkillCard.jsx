  ...
  return (
    <div
      className={cn(
        ...
        "transition-all duration-300 hover:shadow-lg hover:border-gray-800",
        "hover:bg-linear-to-br hover:from-gray-800 hover:to-gray-900"
      )}
    >
      {/* Icon container */}
      <div
      ...
      {/* Proficiency stars */}
      <div className="flex gap-0.5" aria-label={`${level} out of 5 proficiency`}>
